...
rm -rf phpinfo53.php
rm -rf phpinfo54.php
wget -q --show-progress  https://raw.githubusercontent.com/mk-help/mk/main//phpinfo53.php
wget -q --show-progress  https://raw.githubusercontent.com/mk-help/mk/main/phpinfo54.php
cd /opt/mk-auth/admin
rm -rf logout.php
wget -q --show-progress  https://raw.githubusercontent.com/mk-help/mk/main/logout.php
